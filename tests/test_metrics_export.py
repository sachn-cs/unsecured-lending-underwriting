"""Tests for Exporter prometheus text formatting."""

from __future__ import annotations

from unittest.mock import MagicMock

from underwrite.prometheus_export import Exporter, PrometheusMiddleware
...
class TestMetricsExporter:
    def test_empty_metrics_returns_trailing_newline(self) -> None:
        rt = _mock_runtime({})
        text = Exporter.to_prometheus_text(rt)
        assert text == "\n"
